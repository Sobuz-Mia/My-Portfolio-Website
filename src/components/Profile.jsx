...
const Profile = () => {
    return (
        <div className="flex items-center gap-5 absolute right-0 left-0 flex-col md:flex-row">
            <div className="">
                <Lottie className="h-screen w-full" animationData={animation} loop={true}></Lottie>
            </div>

            <div className="w-2/3">
                <h1 className="profile-desc font-bold italic md:text-4xl text-lg">I am Junior MERN Stack Developer <br /> & <br /> Student of Computer Science</h1>
